...
export class UpdateProductsTemplate extends BaseImportService {
  ...
  @ImportTemplateField({name: 'sku', importFieldName: 'REFERENCE', required: true, type: 'text', description: 'The SKU of the product to update'})
  public sku: string;

  @ImportTemplateField({name: 'active', importFieldName: 'active', required: true, type: 'boolean', description: 'The new active status of the product. true = active, false = inactive'})
