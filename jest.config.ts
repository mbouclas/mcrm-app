...
export default {
  ...
  moduleNameMapper: {
    ...
    '~crm/(.*)$': '<rootDir>/src/crm/$1',
    '~cli/(.*)$': '<rootDir>/src/cli/$1',
    '~cms/(.*)$': '<rootDir>/src/cms/$1',
    '~user/(.*)$': '<rootDir>/src/user/$1',
    '~admin/(.*)$': '<rootDir>/src/admin/$1',
    '~catalogue/(.*)$': '<rootDir>/src/catalogue/$1',
    '~es/(.*)$': '<rootDir>/src/elastic-search/$1',
    '~eshop/(.*)$': '<rootDir>/src/eshop/$1',
  ...
  // cacheDirectory: "C:\\Users\\mbouc\\AppData\\Local\\Temp\\jest",
